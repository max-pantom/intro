  ...
  return (
    ...
    >
      <main className="relative h-full overflow-hidden px-4 pb-5 pt-6 md:px-6">
        <section className="absolute left-5 top-6 z-10 space-y-2 font-mono text-[16px] leading-none uppercase tracking-[0.02em] text-black/46 md:left-6">
          <p>CURRENTLY ACCEPTING</p>
          <p className="pantom-badge-pulse-black inline-block bg-[#c7c7c7] px-[4px] py-[2px] text-[#676767]">2 NEW PROJECTS.</p>
        </section>

        <Link
          href="/"
          aria-label="Go back home"
          className={`absolute left-1/2 z-10 -translate-x-1/2 transition-[width,height,top,transform] duration-300 hover:skew-x-[-10deg] active:skew-x-[-10deg] ${hasStarted ? "top-[24px] h-[35px] w-[95px]" : "top-[24px] h-[70px] w-[190px]"}`}
        >
          <svg className="size-full" viewBox="0 0 190 70" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Pantom logo">
