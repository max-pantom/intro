    ...
    >
      <main className="relative h-full overflow-hidden px-4 pb-5 pt-6 md:px-6">
        <section className="absolute left-5 top-6 z-10 space-y-2 font-mono text-[16px] leading-none uppercase tracking-[0.02em] text-black/46 md:left-6">
          ...
          <p className="inline-block bg-[#c7c7c7] px-[4px] py-[2px] text-[#676767]">2 NEW PROJECTS.</p>
        </section>

        <div
          className={`pointer-events-none absolute left-1/2 z-10 -translate-x-1/2 transition-[width,height,top] duration-300 ${hasStarted ? "top-[24px] h-[35px] w-[95px]" : "top-[24px] h-[70px] w-[190px]"}`}
        >
