...
export default async function FoundersPage() {
  ...
  return (
    <div className="page flex min-h-dvh w-full flex-col bg-white">
      <header className="flex items-center justify-between px-[24px] pt-[24px]">
        ...
        <div className="flex flex-1 justify-end">
          <a
            ...
            className="book-a-call rounded-full bg-[#e0e0e0] px-4 py-2 font-sans text-base font-semibold text-[#717171] no-underline hover:bg-[#d8d8d8]"
          >
            Book a call
          </a>
        </div>
      ...
      <main className="flex flex-1 flex-col items-center px-5 pt-[122px] pb-[40px] transition-[filter] duration-300 md:px-[40px] [.page:has(.book-a-call:hover)_&]:blur-sm">
        <h1 className="text-center text-[32px] font-semibold leading-tight tracking-[-0.01em] text-[#666666] md:text-[52px]">
          landing page for
          <br />
          ...
          {pills.map((label, index) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-center text-base font-medium text-[#767676]">{label.replace(/^\+ /, "")}</span>
              </div>
            )
          })}
        </div>
        ...
        <div className="group founders-card-group mt-[64px] flex flex-col items-center">
          ...
          >
            ...
            <div className="absolute bottom-[18px] left-[18px] right-[18px] flex items-baseline justify-between text-[#585858]">
              <span className="text-[24px] font-semibold">$951</span>
              <span className="text-[16px] font-medium line-through text-[#585858]/50">$2699</span>
            </div>
          </a>
          <p className="founders-click-shiver founders-click-shimmer mt-[16px] flex cursor-pointer items-center gap-1.5 rounded px-1 py-0.5 font-sans text-[14px] font-semibold text-[#B8B8B8] transition-colors duration-300 group-hover:text-[#3E3E3E] hover:text-[#2E2E2E]">
            <svg
              width="14"
              height="14"
              viewBox="0 0 14 14"
