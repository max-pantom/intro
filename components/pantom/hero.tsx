...
export function HeroSection() {
  return (
    <header data-analytics-section="hero" className="pantom-reveal grid gap-10 border-b border-[#1f1a16]/20 pb-12 dark:border-[#e8dfd3]/20 md:grid-cols-[1.25fr_0.75fr]">
